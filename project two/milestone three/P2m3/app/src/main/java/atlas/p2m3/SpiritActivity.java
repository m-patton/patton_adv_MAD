...
public class SpiritActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                Intent intent1 = new Intent(SpiritActivity.this,DataActivity.class);
        ...
        button2.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent2 = new Intent(SpiritActivity.this,SpiritTipsActivity.class);
    ...
    public void changeButton(View view) {
        ...
        Drawable spirit = getResources().getDrawable(R.drawable.spirit_button);
        if(checked){ //this means have mood
            ...
            ((ToggleButton)view).setBackgroundDrawable(spirit);
            switch(view.getId()){
                case R.id.tmb1:
                    c1 += 1;
                    String str = String.valueOf(c1);
