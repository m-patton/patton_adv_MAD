...
class TableViewController: UITableViewController, NoteViewDelegate {
    ...
    @IBAction func newNote() {
        ...
        var newEntry = ["title" : dateStr, "body" : "" , "body2" : ""]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        print(selectedIndex)
        dailyNoteView.navigationItem.title = arrNotes[self.selectedIndex]["title"]
        dailyNoteView.strBodyText = arrNotes[self.selectedIndex]["body"]
        dailyNoteView.strBodyText2 = arrNotes[self.selectedIndex]["body2"]
